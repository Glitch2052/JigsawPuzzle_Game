    ...
    public class RecyclableScrollRect : ScrollRect
    {
        ...
        public int Segments
        {
            set
            {
                ...
                if (_recyclingSystem is VerticalRecyclingSystem or HorizontalRecyclingSystem)
                    _recyclingSystem._coloumns = _segments;
            }
            get => _segments;
        }
        ...
        public void UpdatePrototypeCell(RectTransform newPrototypeCell)
        {
            if(_recyclingSystem == null) return;
            _recyclingSystem.PrototypeCell = newPrototypeCell;
        }
        ...
        {
            if (_recyclingSystem is VerticalRecyclingSystem)
            {
                ((VerticalRecyclingSystem)_recyclingSystem).OnDrawGizmos();
            }

            if (_recyclingSystem is HorizontalRecyclingSystem)
            {
                ((HorizontalRecyclingSystem)_recyclingSystem).OnDrawGizmos();
            }
